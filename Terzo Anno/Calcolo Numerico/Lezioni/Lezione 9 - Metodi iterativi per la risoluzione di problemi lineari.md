...
&\le \mu(A)\epsilon 
\end{align*}$$ dove $\mu(A)=||A||\:||A^{-1}||$ si chiama numero di condizionamento della matrice $A$ in norma $||\cdot||$.
**Oss.**
