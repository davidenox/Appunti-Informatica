...
Sia allora $L_1$ un qualsiasi linguaggio in NP (ossia,  L1  NP ): allora, L1c  coNP 
poiché Lc è completo per la classe coNP, allora per ogni L0  coNP, L0 Lc: allora, in particolare, poiché L1c  coNP, vale che L1c Lc 
